...
public class Interfaz extends javax.swing.JFrame {
    ...
    public Interfaz() {
        ...
        txtExpression.setText("{3*(7-6)-{3*7}-[6-3]}");
    }
    ...
    private void initComponents() {
        ...
        txtExpression.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(txtExpression, javax.swing.GroupLayout.PREFERRED_SIZE, 305, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(17, 17, 17))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(ValidateExpression()){
            ...
            JOptionPane.showMessageDialog(null, "LA FORMULA NO ESTA ESCRITA CORRECTAMENTE.");
        }
    ...
    public boolean ValidateExpression(){
        ...
        String cad = txtExpression.getText();
        
        for(int i = 0; i < cad.length(); i++){
            if(cad.charAt(i) == '(' || cad.charAt(i) == '{' || cad.charAt(i) == '['){
                pila.insert(cad.charAt(i));
            }else{
                if(cad.charAt(i) == ')'){
                    if(pila.extract() != '('){
                        return false;
