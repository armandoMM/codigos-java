...
import static proyecto2D.PaintPanel.BS;
import static proyecto2D.PaintPanel.NONE;
import static proyecto2D.PaintPanel.grosorGlobal;
...
public class PanelObjetos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Panel2.setPreferredSize(new java.awt.Dimension(930, 640));
        add(Panel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 0, 750, 590));

        panelButtonStroke.setBackground(new java.awt.Color(165, 190, 204));
        ...
        BotonContorno.setBackground(new java.awt.Color(165, 190, 204));
        BotonContorno.setFont(new java.awt.Font("Corbel", 1, 14)); // NOI18N
        BotonContorno.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/baseline_border_color_black_24dp.png"))); // NOI18N
        BotonContorno.setToolTipText("*PARA OBJETOS FUTUROS");
        BotonContorno.setBorder(null);
        BotonContorno.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BotonContornoActionPerformed(evt);
            }
        });
        panelButtonStroke.add(BotonContorno, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 70, 60));

        BotonRelleno.setBackground(new java.awt.Color(165, 190, 204));
        BotonRelleno.setFont(new java.awt.Font("Corbel", 1, 14)); // NOI18N
        BotonRelleno.setForeground(new java.awt.Color(165, 190, 204));
        BotonRelleno.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/baseline_format_color_fill_black_24dp.png"))); // NOI18N
        ...
        panelButtonStroke.add(BotonRelleno, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 110, 60, 60));
        ...
        panelButtonStroke.add(jSlider1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 290, 200, 30));

        jLabel2.setFont(new java.awt.Font("Ink Free", 1, 20)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(36, 58, 115));
        jLabel2.setText("Grosor");
        panelButtonStroke.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 260, -1, -1));

        labelColorCont.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        labelColorCont.setForeground(new java.awt.Color(242, 235, 233));
        labelColorCont.setText("ACTUAL");
        panelButtonStroke.add(labelColorCont, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 60, 30));

        labelColorRell.setFont(new java.awt.Font("Arial Black", 0, 12)); // NOI18N
        labelColorRell.setForeground(new java.awt.Color(242, 235, 233));
        labelColorRell.setText("ACTUAL");
        panelButtonStroke.add(labelColorRell, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 170, 60, 30));
        ...
        panelButtonStroke.add(opcionesStrokeGolbal, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 220, 170, 30));

        jLabel3.setFont(new java.awt.Font("Ink Free", 1, 20)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(36, 58, 115));
        jLabel3.setText("Línea");
        jLabel3.setToolTipText("");
        panelButtonStroke.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, 50, 40));

        jButton1.setBackground(new java.awt.Color(36, 58, 115));
        jButton1.setFont(new java.awt.Font("Ink Free", 1, 14)); // NOI18N
        jButton1.setForeground(new java.awt.Color(242, 235, 233));
        ...
        panelButtonStroke.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(89, 130, -1, -1));

        jLabel6.setFont(new java.awt.Font("Ink Free", 0, 24)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(153, 0, 187));
        jLabel6.setText("Relleno");
        panelButtonStroke.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 70, -1, -1));

        jLabel7.setFont(new java.awt.Font("Ink Free", 1, 24)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(36, 58, 115));
        jLabel7.setText("Propiedades ");
        panelButtonStroke.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 40, -1, -1));
        ...
        panelButtonStroke.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, -1, -1));

        jLabel10.setFont(new java.awt.Font("Arial Black", 0, 30)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(124, 62, 102));
        jLabel10.setText("Paint 2D");
        panelButtonStroke.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 0, -1, -1));

        jLabel5.setFont(new java.awt.Font("Ink Free", 1, 20)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(36, 58, 115));
        jLabel5.setText("Figuras predeterminadas");
        panelButtonStroke.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, 240, 20));
        ...
        jLabel1.setForeground(new java.awt.Color(36, 58, 115));
        jLabel1.setText("Figuras Custom");
        panelButtonStroke.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 380, 150, 20));
        ...
        TransformToggleB.setBackground(new java.awt.Color(36, 58, 115));
        TransformToggleB.setFont(new java.awt.Font("Ink Free", 1, 14)); // NOI18N
        TransformToggleB.setForeground(new java.awt.Color(255, 255, 255));
        TransformToggleB.setText("Transform");
        TransformToggleB.setBorder(null);
        TransformToggleB.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                TransformToggleBStateChanged(evt);
            }
        });
        panelButtonStroke.add(TransformToggleB, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 440, 120, 20));
        ...
        panelButtonStroke.add(opcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 470, 190, 20));

        StrokeToggleB.setBackground(new java.awt.Color(36, 58, 115));
        StrokeToggleB.setFont(new java.awt.Font("Ink Free", 1, 14)); // NOI18N
        StrokeToggleB.setForeground(new java.awt.Color(255, 255, 255));
        StrokeToggleB.setText("Stroke y Color");
        StrokeToggleB.setBorder(null);
        StrokeToggleB.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                StrokeToggleBStateChanged(evt);
            }
        });
        panelButtonStroke.add(StrokeToggleB, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 500, 120, 20));
        ...
        panelButtonStroke.add(opcion1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 530, 190, 20));

        InfoCoordenadas.setBackground(new java.awt.Color(153, 153, 153));
        InfoCoordenadas.setForeground(new java.awt.Color(255, 255, 255));
        panelButtonStroke.add(InfoCoordenadas, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 560, 180, 20));

        add(panelButtonStroke, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 260, 590));

        PanelObjetos.setBackground(new java.awt.Color(165, 190, 204));
        PanelObjetos.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        SeleccToggleB.setBackground(new java.awt.Color(165, 190, 204));
        ...
        SeleccToggleB.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/baseline_north_west_black_24dp.png"))); // NOI18N
        SeleccToggleB.setBorder(null);
        ...
        PanelObjetos.add(SeleccToggleB, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 60, 60));

        sSimple.setBackground(new java.awt.Color(165, 190, 204));
        sSimple.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/outline_photo_size_select_large_black_24dp.png"))); // NOI18N
        sSimple.setBorder(null);
        sSimple.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sSimpleActionPerformed(evt);
            }
        });
        PanelObjetos.add(sSimple, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, 60, 50));

        sMultiple.setBackground(new java.awt.Color(165, 190, 204));
        sMultiple.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/outline_select_all_black_24dp.png"))); // NOI18N
        sMultiple.setBorder(null);
        sMultiple.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sMultipleActionPerformed(evt);
            }
        });
        PanelObjetos.add(sMultiple, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 410, 60, 50));

        BotonBorrar.setBackground(new java.awt.Color(165, 190, 204));
        BotonBorrar.setFont(new java.awt.Font("Corbel", 1, 14)); // NOI18N
        BotonBorrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/outline_layers_clear_black_24dp.png"))); // NOI18N
        ...
        PanelObjetos.add(BotonBorrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 530, 60, 60));

        sDoble.setBackground(new java.awt.Color(165, 190, 204));
        sDoble.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/outline_filter_none_black_24dp.png"))); // NOI18N
        sDoble.setBorder(null);
        sDoble.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sDobleActionPerformed(evt);
            }
        });
        PanelObjetos.add(sDoble, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 350, 60, 50));

        BotonAbrirSesion.setBackground(new java.awt.Color(165, 190, 204));
        BotonAbrirSesion.setFont(new java.awt.Font("Corbel", 1, 14)); // NOI18N
        BotonAbrirSesion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/baseline_file_open_black_24dp.png"))); // NOI18N
        BotonAbrirSesion.setBorder(null);
        BotonAbrirSesion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BotonAbrirSesionActionPerformed(evt);
            }
        });
        PanelObjetos.add(BotonAbrirSesion, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, 60, 60));

        BotonGuardarSesion.setBackground(new java.awt.Color(165, 190, 204));
        BotonGuardarSesion.setFont(new java.awt.Font("Corbel", 1, 14)); // NOI18N
        BotonGuardarSesion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/baseline_save_black_24dp.png"))); // NOI18N
        BotonGuardarSesion.setBorder(null);
        BotonGuardarSesion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BotonGuardarSesionActionPerformed(evt);
            }
        });
        PanelObjetos.add(BotonGuardarSesion, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 60, 60));

        BotonLimpiar.setBackground(new java.awt.Color(165, 190, 204));
        BotonLimpiar.setFont(new java.awt.Font("Corbel", 1, 14)); // NOI18N
        BotonLimpiar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/baseline_delete_black_24dp.png"))); // NOI18N
        ...
        PanelObjetos.add(BotonLimpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, 60, 60));

        quitarSeleccion.setBackground(new java.awt.Color(165, 190, 204));
        quitarSeleccion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/outline_deselect_black_24dp.png"))); // NOI18N
        quitarSeleccion.setBorder(null);
        quitarSeleccion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                quitarSeleccionActionPerformed(evt);
            }
        });
        PanelObjetos.add(quitarSeleccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 470, 60, 50));

        add(PanelObjetos, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 0, 80, 590));
