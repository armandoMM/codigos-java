...
public class Cajera {
	...
	public void procesarCompra(Cliente cliente, long timeStamp) {
		...
		System.out.println("La cajera " + this.nombre + " COMIENZA A PROCESAR LA COMPRA DEL CLIENTE " + cliente.getNombre() + " EN EL TIEMPO: " + (System.currentTimeMillis() - timeStamp) / 1000
				+ "seg");

		for (int i = 0; i < cliente.getCarroCompra().length; i++) {
			// Se procesa el producto en X segundos
